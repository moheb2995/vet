  ...
  <div className="center ">
    <div className="z-40 bg-white rounded-xl p-8 px-14 fixed top-[9vh] ">
      ...
      <div className={started?"mt-8 flex justify-between items-center":'hidden'}>
        ...
        <div className="-ml-2">
          <div className={started == 'true'?"mx-2":'hidden'}><DatePickerF setdate={setdate} value={value} setvalue={setvalue} /></div>
      ...
      <div className="flex justify-end mt-10 ">
        <button className='btn-r mx-2' onClick={()=>{setdate(toDate);settype('');setrace('');setname('');setfirstNum('');setlastNum('');setstarted(undefined)}}>انصراف</button>
        <button 
